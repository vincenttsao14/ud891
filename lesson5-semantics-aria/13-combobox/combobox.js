    ...
    ListBox.prototype = {
        ...
        filter: function(str) {
            ...
            if (foundItems === 0) {
                ...
                let position = 1;
                for (let option of this.visibleItems) {
                    option.setAttribute('aria-setsize',foundItems);
                    option.setAttribute('aria-posinset',position);
                    position++;
                };
            };
        },
        ...
        changeActiveListitem: function(newIdx) {
            ...
            // console.log('hi', newActive.id, input)
